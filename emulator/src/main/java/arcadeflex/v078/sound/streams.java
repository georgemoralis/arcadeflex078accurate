...
public class streams {
    ...
    public static abstract interface StreamInitHandlerPtr {

        public abstract void handler(int param, ShortPtr buffer, int length);
    }

    public static abstract interface StreamInitMultiHandlerPtr {
    ...
    static StreamInitHandlerPtr[] stream_callback = new StreamInitHandlerPtr[MIXER_MAX_CHANNELS];
    static StreamInitMultiHandlerPtr[] stream_callback_multi = new StreamInitMultiHandlerPtr[MIXER_MAX_CHANNELS];
 ...
 /* Cut Frequency = 1/(2*Pi*Req*C) */
    ...
    public static int stream_init(String name, int default_mixing_level, int sample_rate, int param, StreamInitHandlerPtr callback) {
        int channel;
    ...
    public static int stream_init_multi(int channels, String[] names, int[] default_mixing_levels, int sample_rate, int param, StreamInitMultiHandlerPtr callback) {
        int channel, i;
