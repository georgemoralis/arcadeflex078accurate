...
/*TODO*///
    public static abstract interface PlotPixelProcHandlerPtr {
        ...
        public abstract void handler(mame_bitmap bitmap, int x, int y, /*pen_t*/ int pen);
    }
...
/*TODO*///
/*TODO*////* 32-bit version */
/*TODO*/////* AAT032503: added limited 32-bit shadow and highlight support
/*TODO*///INLINE UINT32 SHADOW32(UINT32 c) {
/*TODO*///	c = (c>>9&0x7c00) | (c>>6&0x03e0) | (c>>3&0x001f);
/*TODO*///	return(((UINT32*)palette_shadow_table)[c]); }
/*TODO*///
...
/*TODO*////* fill a bitmap using the specified pen */
    public static void fillbitmap(mame_bitmap dest, int/*pen_t*/ pen, rectangle clip) {
        throw new UnsupportedOperationException("Unsupported");
...
/*TODO*///			dest->depth == 16 &&
/*TODO*///			paldata >= Machine->remapped_colortable &&
/*TODO*///			paldata < Machine->remapped_colortable + Machine->drv->total_colors)
/*TODO*///		{
