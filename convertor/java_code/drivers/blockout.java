...
public class blockout
{
	...
	static InputPortHandlerPtr input_ports_blockout = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( blockout )
		PORT_START();       /* IN0 */
	...
	static InputPortHandlerPtr input_ports_blckoutj = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( blckoutj )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY );
	...
	***************************************************************************/
	...
	static RomLoadHandlerPtr rom_blckoutj = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 )	/* 2*128k for 68000 code */
