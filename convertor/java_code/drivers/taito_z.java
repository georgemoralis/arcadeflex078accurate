...
public class taito_z
{
	...
	***********************************************************/
	...
	static InputPortHandlerPtr input_ports_contcirc = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( contcirc )
		PORT_START();  /* DSW A */
	...
	static InputPortHandlerPtr input_ports_contcrcu = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( contcrcu )
		PORT_START();  /* DSW A */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x01, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x00, "Cockpit" );// analogue accelerator pedal
	...
	static InputPortHandlerPtr input_ports_chasehq = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( chasehq )	// IN3-6 perhaps used with cockpit setup? //
		PORT_START();  /* DSW A */
	...
	static InputPortHandlerPtr input_ports_chasehqj = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( chasehqj )	// IN3-6 perhaps used with cockpit setup? //
		PORT_START();  /* DSW A */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x03, "Upright / Steering Lock" );
		PORT_DIPSETTING(    0x02, "Upright / No Steering Lock" );
	...
	static InputPortHandlerPtr input_ports_enforce = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( enforce )
		PORT_START();  /* DSW A */
	...
	static InputPortHandlerPtr input_ports_bshark = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( bshark )
		PORT_START();  /* DSW A */
	...
	static InputPortHandlerPtr input_ports_bsharkj = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( bsharkj )
		PORT_START();  /* DSW A */
	...
	static InputPortHandlerPtr input_ports_sci = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( sci )	// dsws may be slightly wrong
		PORT_START();  /* DSW A */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Cabinet") );
	...
	static InputPortHandlerPtr input_ports_sciu = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( sciu )	// dsws may be slightly wrong
		PORT_START();  /* DSW A */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x01, "Cockpit" );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
	...
	static InputPortHandlerPtr input_ports_nightstr = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( nightstr )
		PORT_START();  /* DSW A */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x01, "Cockpit" );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
	...
	static InputPortHandlerPtr input_ports_aquajack = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( aquajack )
		PORT_START();  /* DSW A */
	...
	static InputPortHandlerPtr input_ports_aquajckj = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( aquajckj )
		PORT_START();  /* DSW A */
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x80, "Cockpit" );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
	...
	static InputPortHandlerPtr input_ports_spacegun = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( spacegun )
		PORT_START();  /* DSW A */
	...
	static InputPortHandlerPtr input_ports_dblaxle = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( dblaxle )
		PORT_START();  /* DSW A */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	static InputPortHandlerPtr input_ports_pwheelsj = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( pwheelsj )
		PORT_START();  /* DSW A */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadHandlerPtr rom_contcirc = new RomLoadHandlerPtr(){ public void handler(){ 
	...
	static RomLoadHandlerPtr rom_contcrcu = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 )	/* 256K for 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "ic25", 0x00000, 0x20000, CRC(f5c92e42) SHA1(42dfa1895e601df76d7022b83f05c4e5c843fd12) )
	...
	static RomLoadHandlerPtr rom_chasehq = new RomLoadHandlerPtr(){ public void handler(){ 
	...
	static RomLoadHandlerPtr rom_chasehqj = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 )	/* 512K for 68000 code (CPU A) */
	...
	static RomLoadHandlerPtr rom_enforce = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 )	/* 256K for 68000 code (CPU A) */
	...
	static RomLoadHandlerPtr rom_bshark = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 )	/* 512K for 68000 code (CPU A) */
	...
	static RomLoadHandlerPtr rom_bsharkj = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 )	/* 512K for 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "c34_71.98", 0x00000, 0x20000, CRC(df1fa629) SHA1(6cb207e577fac85da654f3dc56e2f9f25c38a76d) )
		ROM_LOAD16_BYTE( "c34_69.75", 0x00001, 0x20000, CRC(a54c137a) SHA1(632bf2d65f54035de2ecb87648dafa877c45e428) )
		ROM_LOAD16_BYTE( "c34_70.97", 0x40000, 0x20000, CRC(d77d81e2) SHA1(d60e586cefd9001e87cae583ca25bf5a8a461d8d) )
	...
	static RomLoadHandlerPtr rom_sci = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 )	/* 512K for 68000 code (CPU A) */
	...
	static RomLoadHandlerPtr rom_scia = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 )	/* 512K for 68000 code (CPU A) */
	...
	static RomLoadHandlerPtr rom_sciu = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 )	/* 512K for 68000 code (CPU A) */
	...
	static RomLoadHandlerPtr rom_nightstr = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 )	/* 512K for 68000 code (CPU A) */
	...
	static RomLoadHandlerPtr rom_aquajack = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 )	/* 256K for 68000 code (CPU A) */
	...
	static RomLoadHandlerPtr rom_aquajckj = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 )	/* 256K for 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "b77-22.rom", 0x00000, 0x20000, CRC(67400dde) SHA1(1e47c4fbd4449f2d973ac962ad58f22502d59198) )
	...
	static RomLoadHandlerPtr rom_spacegun = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 )	/* 512K for 68000 code (CPU A) */
	...
	static RomLoadHandlerPtr rom_dblaxle = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 )	/* 512K for 68000 code (CPU A) */
	...
	static RomLoadHandlerPtr rom_pwheelsj = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 )	/* 512K for 68000 code (CPU A) */
