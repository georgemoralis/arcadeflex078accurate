...
public class toaplan1
{
	...
	*****************************************************************************/
	...
	static InputPortHandlerPtr input_ports_rallybik = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( rallybik )
	...
	static InputPortHandlerPtr input_ports_truxton = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( truxton )
		TOAPLAN1_VBLANK_INPUT
	...
	*/
	...
	static InputPortHandlerPtr input_ports_hellfire = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( hellfire )
		TOAPLAN1_VBLANK_INPUT
	...
	static InputPortHandlerPtr input_ports_hellfir1 = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( hellfir1 )
		TOAPLAN1_VBLANK_INPUT
	...
	static InputPortHandlerPtr input_ports_zerowing = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( zerowing )
		TOAPLAN1_VBLANK_INPUT
	...
	static InputPortHandlerPtr input_ports_demonwld = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( demonwld )
		TOAPLAN1_VBLANK_INPUT
	...
	static InputPortHandlerPtr input_ports_demonwl1 = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( demonwl1 )
		TOAPLAN1_VBLANK_INPUT
	...
	static InputPortHandlerPtr input_ports_samesame = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( samesame )
		TOAPLAN1_VBLANK_INPUT
	...
	*/
	...
	static InputPortHandlerPtr input_ports_samesam2 = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( samesam2 )
		TOAPLAN1_VBLANK_INPUT
	...
	*/
	...
	static InputPortHandlerPtr input_ports_fireshrk = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( fireshrk )
		TOAPLAN1_VBLANK_INPUT
	...
	static InputPortHandlerPtr input_ports_outzone = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( outzone )
		TOAPLAN1_VBLANK_INPUT
	...
	static InputPortHandlerPtr input_ports_vimana = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( vimana )
		TOAPLAN1_VBLANK_INPUT
	...
	static InputPortHandlerPtr input_ports_vimanan = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( vimanan )
		TOAPLAN1_VBLANK_INPUT
	...
	***************************************************************************/
	...
	static RomLoadHandlerPtr rom_rallybik = new RomLoadHandlerPtr(){ public void handler(){ 
	...
	static RomLoadHandlerPtr rom_truxton = new RomLoadHandlerPtr(){ public void handler(){ 
	...
	static RomLoadHandlerPtr rom_hellfire = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_hellfir1 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_zerowing = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x080000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_demonwld = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_demonwl1 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_samesame = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x080000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_samesam2 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x080000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_fireshrk = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x080000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_outzone = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_outzonea = new RomLoadHandlerPtr(){ public void handler(){ 					/* From board serial number 2122 */
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	*/
	...
	static RomLoadHandlerPtr rom_vimana = new RomLoadHandlerPtr(){ public void handler(){ 			/* From board serial number 1547.04 (July '94) */
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_vimana1 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadHandlerPtr rom_vimanan = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
