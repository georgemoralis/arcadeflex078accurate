...
public class legionna
{
	...
	*/
	...
	static InputPortHandlerPtr input_ports_legionna = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( legionna )
	...
	static InputPortHandlerPtr input_ports_heatbrl = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( heatbrl )
		SEIBU_COIN_INPUTS	/* Must be port 0: coin inputs read through sound cpu */
	...
	static InputPortHandlerPtr input_ports_godzilla = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( godzilla )
		SEIBU_COIN_INPUTS	/* Must be port 0: coin inputs read through sound cpu */
	...
	static InputPortHandlerPtr input_ports_sdgndmrb = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( sdgndmrb )
		SEIBU_COIN_INPUTS	/* Must be port 0: coin inputs read through sound cpu */
	...
	static InputPortHandlerPtr input_ports_cupsoc = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( cupsoc )
		SEIBU_COIN_INPUTS	/* Must be port 0: coin inputs read through sound cpu */
