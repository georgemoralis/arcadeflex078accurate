...
public class cps1
{
	...
	***********************************************************/
	...
	static InputPortHandlerPtr input_ports_forgottn = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( forgottn )
		PORT_START();       /* IN0 */
	...
	static InputPortHandlerPtr input_ports_ghouls = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( ghouls )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
	...
	static InputPortHandlerPtr input_ports_ghoulsu = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( ghoulsu )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 ); /* Service, but it doesn't give any credit */
	...
	static InputPortHandlerPtr input_ports_daimakai = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( daimakai )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 ); /* Service, but it doesn't give any credit */
	...
	static InputPortHandlerPtr input_ports_strider = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( strider )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_stridrua = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( stridrua )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_dw = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( dw )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* "Debug" features to be implemented */
	static InputPortHandlerPtr input_ports_willow = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( willow )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_unsquad = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( unsquad )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_ffight = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( ffight )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_1941 = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( 1941 )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_mercs = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( mercs )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	*/
	static InputPortHandlerPtr input_ports_mtwins = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( mtwins )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_msword = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( msword )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_cawing = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( cawing )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* "Debug" features to be implemented */
	static InputPortHandlerPtr input_ports_nemo = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( nemo )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_sf2 = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( sf2 )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_sf2j = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( sf2j )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_3wonders = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( 3wonders )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_kod = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( kod )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_kodj = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( kodj )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_captcomm = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( captcomm )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_knights = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( knights )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_varth = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( varth )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_cworld2j = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( cworld2j )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_wof = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( wof )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_dino = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( dino )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_punisher = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( punisher )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_slammast = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( slammast )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_pnickj = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( pnickj )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_qad = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( qad )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_qadj = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( qadj )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_qtono2 = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( qtono2 )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_pang3 = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( pang3 )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	/* Needs further checking */
	static InputPortHandlerPtr input_ports_megaman = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( megaman )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	static InputPortHandlerPtr input_ports_rockmanj = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( rockmanj )
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );
	...
	***************************************************************************/
	...
	static RomLoadHandlerPtr rom_daimakai = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )
	...
	static RomLoadHandlerPtr rom_stridrua = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_dw = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_willowje = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
		ROM_LOAD16_BYTE( "wlu_30.rom",   0x00000, 0x20000, CRC(d604dbb1) SHA1(b5d78871011ff11a67f1a0cad147cd4de8d67f35) )
	...
	static RomLoadHandlerPtr rom_ffightj1 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_mercsua = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_mswordr1 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_cawingu = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
		ROM_LOAD16_BYTE( "cae_30a.rom",  0x00000, 0x20000, CRC(91fceacd) SHA1(4845999a96fee829264346ca399fdd64a8408001) )
	...
	static RomLoadHandlerPtr rom_sf2eb = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2ua = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2ub = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
		ROM_LOAD16_BYTE( "sf2_30a.bin",   0x00000, 0x20000, CRC(57bd7051) SHA1(5e211e75b1649b07723cabc03cf15636dbbae595) )
	...
	static RomLoadHandlerPtr rom_sf2ud = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2ue = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2uf = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2ui = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
		ROM_LOAD16_BYTE( "sf2e.30g",      0x00000, 0x20000, CRC(fe39ee33) SHA1(22558eb15e035b09b80935a32b8425d91cd79669) )
	...
	static RomLoadHandlerPtr rom_sf2uk = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2ja = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
		ROM_LOAD16_BYTE( "sf2_30a.bin",   0x00000, 0x20000, CRC(57bd7051) SHA1(5e211e75b1649b07723cabc03cf15636dbbae595) )
	...
	static RomLoadHandlerPtr rom_sf2jc = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_3wonderu = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_kodu = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2ceua = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2ceub = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2ceuc = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2rb2 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2v004 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2m1 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2m2 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2m3 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2m4 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2m5 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2m6 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2m7 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2yyc = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_sf2koryu = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_wofu = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	...
	static RomLoadHandlerPtr rom_dinou = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
