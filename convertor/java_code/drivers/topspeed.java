...
public class topspeed
{
	...
	***********************************************************/
	...
	static InputPortHandlerPtr input_ports_topspeed = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( topspeed )
		PORT_START();  /* DSW A */
	...
	static InputPortHandlerPtr input_ports_topspedu = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( topspedu )
		PORT_START();  /* DSW A */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x03, "Deluxe Motorized Cockpit" );
		PORT_DIPSETTING(    0x02, "Upright (?"));
	...
	static InputPortHandlerPtr input_ports_fullthrl = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( fullthrl )
		PORT_START();  /* DSW A */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x03, "Deluxe Motorized Cockpit" );
		PORT_DIPSETTING(    0x02, "Upright (?"));
