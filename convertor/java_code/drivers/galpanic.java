...
public class galpanic
{
	...
	static InputPortHandlerPtr input_ports_galpanic = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( galpanic )
		PORT_START(); 
	...
	static InputPortHandlerPtr input_ports_galpanib = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( galpanib )
		PORT_START(); 
		PORT_DIPNAME( 0x0001, 0x0001, DEF_STR( "Unused") );
		PORT_DIPSETTING(      0x0001, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	...
	static InputPortHandlerPtr input_ports_fantasia = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( fantasia )
		PORT_START(); 
		PORT_DIPNAME( 0x0003, 0x0003, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x0002, "Easy" );
		PORT_DIPSETTING(      0x0003, "Normal" );
	...
	static InputPortHandlerPtr input_ports_missw96 = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( missw96 )
		PORT_START(); 
		PORT_DIPNAME( 0x0003, 0x0003, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x0002, "Easy" );
		PORT_DIPSETTING(      0x0003, "Normal" );
	...
	static InputPortHandlerPtr input_ports_galhustl = new InputPortHandlerPtr(){ public void handler() { INPUT_PORTS_START( galhustl )
		PORT_START(); 
