...
public class mcr68
{
	...
	public static GetTileInfoHandlerPtr zwackery_get_bg_tile_info = new GetTileInfoHandlerPtr() { public void handler(int tile_index) 
	{
	...
	public static GetTileInfoHandlerPtr zwackery_get_fg_tile_info = new GetTileInfoHandlerPtr() { public void handler(int tile_index) 
	{
		int data = videoram16[tile_index];
		int color = (data >> 13) & 7;
